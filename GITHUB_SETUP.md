...
- Configure the six release secrets listed in `RELEASING.md`.
...
3. Create and push the `v1.0.0` tag only after release secrets are configured.
4. Wait for the Release workflow to sign, notarize, staple, package, checksum,
   and publish all three assets.
5. Download the public assets on a clean Mac and repeat Gatekeeper and checksum
